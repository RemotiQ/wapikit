...
CREATE TABLE "public"."Notification" (
  ...
  "OrganizationMemberId" uuid NULL,
  "OrganizationId" uuid NULL,
  PRIMARY KEY ("UniqueId"),
  CONSTRAINT "NotificationToOrganizationForeignKey" FOREIGN KEY ("OrganizationId") REFERENCES "public"."Organization" ("UniqueId") ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT "NotificationToOrganizationMemberForeignKey" FOREIGN KEY ("OrganizationMemberId") REFERENCES "public"."OrganizationMember" ("UniqueId") ON UPDATE NO ACTION ON DELETE NO ACTION
);
-- Create index "NotificationOrganizationIdIndex" to table: "Notification"
CREATE INDEX "NotificationOrganizationIdIndex" ON "public"."Notification" ("OrganizationId");
-- Create index "NotificationOrganizationMemberIdIndex" to table: "Notification"
CREATE INDEX "NotificationOrganizationMemberIdIndex" ON "public"."Notification" ("OrganizationMemberId");
